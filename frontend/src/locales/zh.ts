export default {
  ...
  mcpService: {
    ...
    stats: {
      ...
      successRate: "成功率",
      avgDuration: "平均耗时",
      trendTitle: "近 15 天调用趋势",
      toolDistributionTitle: "工具调用占比",
      logsTitle: "调用明细日志",
      logsSubtitle: "记录每次工具执行明细（默认保留 15 天）",
      toolFilterPlaceholder: "按工具名筛选",
      statusAll: "全部状态",
      statusSuccess: "成功",
      statusFailed: "失败",
      time: "调用时间",
    ...
    tool: {
      ...
      paramDesc: "参数说明",
      paramRequired: "必填",
      sysVarUserId: "当前调用者用户 ID",
      sysVarUserName: "当前调用者用户名",
      sysVarUserDisplayName: "当前调用者显示名",
      sysVarNow: "当前时间戳 (yyyy-MM-dd HH:mm:ss)",
      sysVarDate: "当前日期 (yyyy-MM-dd)",
