export default {
  ...
  mcpService: {
    ...
    stats: {
      ...
      trendTitle: "Last 15 Days Trend",
      toolDistributionTitle: "Tool Distribution",
      logsTitle: "Invocation Logs",
      logsSubtitle: "Detailed log of each tool invocation (retained for 15 days)",
      toolFilterPlaceholder: "Filter by tool name",
      ...
      emptyLogs: "No invocation logs found",
      emptyStats: "No usage statistics available",
      refresh: "Refresh",
      callCount: "Calls",
      ms: "ms",
      times: "calls",
      ...
      failedCount: "Failed",
      unknownCaller: "Anonymous/System",
    },
    ...
    tool: {
      ...
      sysVarUserId: "Current user ID",
      sysVarUserName: "Current username",
      sysVarUserDisplayName: "Current user display name",
      sysVarNow: "Current timestamp (yyyy-MM-dd HH:mm:ss)",
      sysVarDate: "Current date (yyyy-MM-dd)",
      configExecuteSql: "Configure: SQL Execution",
      ...
      maxRows: "Max Rows",
      timeout: "Timeout",
      annotationsSection: "MCP Annotations",
      annotationsSectionHint: "Declares runtime behavior hints to guide LLMs and clients for permission decisions and safe retries (omitted if unset).",
      annotationUnset: "Unset",
      annotationYes: "Yes",
      annotationNo: "No",
      readOnlyLabel: "Read-only",
      readOnlyDesc: "Whether the tool only reads data without modifying system state",
      idempotentLabel: "Idempotent",
      idempotentDesc: "Whether repeated calls with the same arguments produce identical state and results (safe to retry)",
      destructiveLabel: "Destructive",
      destructiveDesc: "Whether the tool performs irreversible actions such as deleting or dropping data",
      detectAnnotations: "Auto Detect",
      detectSuccess: "Recommended annotations detected for {op} query",
      detectEmptySql: "Please enter a SQL template first",
    ...
    toolTest: {
      ...
      listTermsTitle: "Business Terms in Service Data Scope",
      emptyTableList: "No tables in data scope",
      emptyTableAndTermList: "No tables or terms in data scope",
      tables: "tables",
      terms: "terms",
      entityType: {
        TABLE: "Table",
      ...
      descriptionPlaceholder: "New description (leave empty to keep)",
      aliasesPlaceholder: "Aliases (REPLACES all, press Enter)",
      dataSourcePlaceholder: "Select data source",
      schemaPlaceholder: "Schema (optional)",
      ...
      addRow: "Add row",
      addTerm: "Add term",
      noSubjectInScope: "Service has no subject in scope; cannot write terms",
      termNamePlaceholder: "Select an existing term to update, or type a new name to create",
      termRow: "Term {n}",
      termName: "Term Name",
      subjectPlaceholder: "Select a subject",
      summaryTotal: "{total} item(s) total",
  ...
  apiKeys: {
    title: "API Keys",
    subtitle: "Create and manage personal API Keys for API and MCP service access",
    ...
    expiresInDaysLabel: "Expiration (Days)",
    expired: "Expired",
    deleteTitle: "Delete API Key",
    deleteConfirm: "Delete API Key \"{name}\"? It becomes invalid immediately and cannot be recovered.",
    deleted: "Deleted",
    never: "Never",
    days7: "7 days",
    days30: "30 days",
    ...
    showOnceWarning: "This API Key is shown only once upon creation. Please save it securely.",
    usageGuideTitle: "Client Usage Example",
    usageGuideDesc: "Include the Authorization Header in HTTP requests for authentication:",
    emptyList: "No API keys yet. Create one from the top right.",
  },
};
