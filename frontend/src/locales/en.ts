...
annotationsPreview: "MCP Annotations Preview",
    ...
    toolTest: {
      ...
      termNameHint: "Select an existing term to auto-fill its description and aliases, or type a new name to create one",
      termAutoFilledHint: "Current description and aliases loaded; edit them if needed",
    },
  },
